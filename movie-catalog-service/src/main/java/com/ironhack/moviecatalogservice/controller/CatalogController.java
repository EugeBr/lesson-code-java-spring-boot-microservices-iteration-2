...
public class CatalogController {
    ...
    public Catalog getCatalog(@PathVariable int userId) {
        ...
        User user = restTemplate.getForObject("http://ratings-data-service/api/users/" + userId, User.class);
        UserRating userRatings = restTemplate.getForObject("http://ratings-data-service/api/users/" + userId + "/ratings", UserRating.class);
